...
I applied the full LST workflow to Ahmedabad using Landsat 8 scenes filtered to the Indian hot season (April–September, 2019–2022) with cloud cover below 1%. After applying the thermal scaling factor (×0.00341802 + 149.0) and converting from Kelvin to Celsius, the mean composite revealed a striking urban heat island signature entirely consistent with the problem framing in our Slide 2. The dense built-up core reaches 45–50°C, while the Sabarmati River corridor is 10–15°C cooler — exactly the kind of intra-urban spatial variation that our presentation argues is invisible to the meteorological station network that the current HAP relies on.

![Landsat 8 mean LST (April–September, 2019–2022) showing pronounced UHI in Ahmedabad's built-up core and cooling along the Sabarmati River corridor.](images/clipboard-124381120.png)
...
![MODIS Terra + Aqua merged LST time series for Ahmedabad AMC, 2019–2022. Pre-monsoon peaks consistently exceed 50°C, with a sharp monsoon-season decline.](images/clipboard-3944389524.png)
...
![Ward-level heat index overlaid on Landsat LST. Deep red wards represent the hottest decile of the city — a spatial pattern invisible from meteorological stations alone.](images/clipboard-1056075578.png)
...
![MODIS LST Visualization in 1km pixel (Well this is certainly not the best way to present heat change in large scale...)](images/clipboard-3632687557.png)
