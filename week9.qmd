...
![Placebo test using 2018 as a control year (same date cutoff: 12 August). The substantially reduced change signal compared to 2015 confirms that the detection algorithm is responding to the explosion event rather than routine port activity.](images/clipboard-1068903264.png)
